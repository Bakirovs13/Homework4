...
public class Main {
    ...
    //Танк имеет ольше дизни и слабвый удар.может принимать часть удара босса на других игроков себе
    public static int[] heroesHealth = {250, 250, 250, 100, 500};
    public static int[] heroesDamage = {25, 25, 25, 0, 15};
    public static String[] heroesname = {"Zhack", "Mike", "Otis", "Doctor", "Tank"};
